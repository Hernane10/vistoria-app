...
// ============================================================
// 📷 MEDIA PICKER (Cartões coloridos)
// ============================================================
    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-center justify-between gap-1">
        ...
        <button type="button" onClick={() => cameraRef.current?.click()} style={cardStyle}>
          <div style={{ ...iconBoxStyle, background: "#2d4a32", border: "1px solid #6fbf73" }}>
            <Camera size={24} color="#7ed957" />
          </div>
          <span style={labelStyle}>Tirar foto</span>
        </button>

        {/* 2. Enviar arquivo (Azul) */}
        <button type="button" onClick={() => galleryRef.current?.click()} style={cardStyle}>
          <div style={{ ...iconBoxStyle, background: "#1d3a5f", border: "1px solid #5c9ce6" }}>
            <Paperclip size={24} color="#4da6ff" />
          </div>
          <span style={labelStyle}>Enviar arquivo</span>
        </button>

        {/* 3. Gravar vídeo (Vermelho) */}
        <button type="button" onClick={() => { setRecError(""); setRecordingVideo(true); }} style={cardStyle}>
          <div style={{ ...iconBoxStyle, background: "#5e1f1f", border: "1px solid #e66c6c" }}>
            <Video size={24} color="#ff5c5c" />
          </div>
          <span style={labelStyle}>Gravar vídeo</span>
        </button>

        {/* 4. Enviar vídeo (Preto) */}
        <button type="button" onClick={() => videoRef.current?.click()} style={cardStyle}>
          <div style={{ ...iconBoxStyle, background: "#000", border: "1px solid #ffffff" }}>
            <Video size={24} color="#fff" fill="#fff" />
          </div>
          <span style={labelStyle}>Enviar vídeo</span>
        </button>
      </div>
      ...
      <input ref={galleryRef} type="file" accept="image/*,video/*" multiple={multiple} className="hidden" onChange={handlePick} />
...
// ============================================================
// 🎯 PHOTO ANNOTATOR (Marcar avarias em fotos)
// ============================================================
